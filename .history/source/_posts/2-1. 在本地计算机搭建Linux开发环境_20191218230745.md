...
![6](../images/linux-environment/06.png)
    ...
    4.1. yum install git #安装过程较冗长，慢慢等待。此命令安装了 git v1 版本较低
    ...
    4.2. yum remove git #先卸载低版本 git
    4.3. yum install -y zlib-devel bzip2-devel openssl-devel ncurses-devel gcc perl-ExtUtils-MakeMaker package #安装依赖包
