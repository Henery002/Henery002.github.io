...
![6](../images/linux-environment/06.png)
    ...
    5. yum remove git #先卸载低版本 git
        1. yum install -y zlib-devel bzip2-devel openssl-devel ncurses-devel gcc perl-ExtUtils-MakeMaker package #安装依赖包
        ...
        2.  下载高版本 git ( https://www.kernel.org/pub/software/scm/git/git-2.13.2.tar.gz)，使用命令 tar -xvf name 解压放于 linux 服务器 /usr/src 下
        3.  cd git-2.13.2
